...
const features = [
  ...
  { title: 'Community Insights', detail: 'Real-time insights from thousands of people switching every day.', Icon: UserIcon, color: 'text-rose-600', bg: 'bg-rose-100' },
]
...
function TrustBadges() {
  const badges = [
    ...
    { title: 'Trusted by 250,000+ users', detail: '250,000+ users', Icon: UserIcon },
  ]
  return (
